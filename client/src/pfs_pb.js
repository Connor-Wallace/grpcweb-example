...
goog.exportSymbol('proto.pfs.Merge', null, global);
 ...
 * @constructor
 */
proto.pfs.Merge = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.pfs.Merge.repeatedFields_, null);
};
goog.inherits(proto.pfs.Merge, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pfs.Merge.displayName = 'proto.pfs.Merge';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.pfs.CommitInfo.prototype.clearParentCommit = function() {
  this.setParentCommit(undefined);
};
 ...
 * @const
 */
proto.pfs.Merge.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.pfs.Merge.prototype.toObject = function(opt_includeInstance) {
  return proto.pfs.Merge.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pfs.Merge} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pfs.Merge.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pfs.Merge}
 */
proto.pfs.Merge.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pfs.Merge;
  return proto.pfs.Merge.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pfs.Merge} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pfs.Merge}
 */
proto.pfs.Merge.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pfs.Merge.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pfs.Merge.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pfs.Merge} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pfs.Merge.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.pfs.Merge.prototype.getPrefixesList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 1));
};


/** @param {!Array<string>} value */
proto.pfs.Merge.prototype.setPrefixesList = function(value) {
 ...
 * @param {number=} opt_index
 */
proto.pfs.Merge.prototype.addPrefixes = function(value, opt_index) {
 ...
 * Clears the list making it empty but non-null.
 */
proto.pfs.Merge.prototype.clearPrefixesList = function() {
...
proto.pfs.PutFileRequest.prototype.clearOverwriteIndex = function() {
  this.setOverwriteIndex(undefined);
};
  ...
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.pfs.BlockRef.deserializeBinaryFromReader, "");
         });
      break;
    case 2:
      var value = msg.getTagsMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.pfs.Object.deserializeBinaryFromReader, "");
         });
      break;
    default:
      reader.skipField();
